    ...
    then
        ...
        then
            ...
            do
                ...
                g = {}
                g.x = wa.x + wa.width - slavearea
                g.y = wa.y
                g.width = slavewid
                g.height = slavehei

                -- Not all slaves use the exact geometry specified. Have the last slave
                -- use up all the remaining space
                if i == #slave then
                    g.width = slavearea
                end
                ...
                g_new = c:geometry(g)
                slavearea = slavearea - g_new.width
            end
        end
    end
end
