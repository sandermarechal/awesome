...
vicious.register(memwidget, vicious.widgets.mem, ' <span color="white">MEM:</span> $1% $5%')
...
tyrannical.tags = {
    ...
    },
    {
        ...
        class = {"Firefox", "Firefox Developer Edition", "Chromium"},
    },
    {
        name = "files",
        init = false,
